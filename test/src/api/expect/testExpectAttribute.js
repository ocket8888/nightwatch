...
describe('expect.attribute', function() {
  ...
  it('to have attribute equal with custom waitFor [PASSED]', function() {
    ...
    const expect = this.client.api.expect.element('#weblogin').to.have.attribute('class').equal('hp vasq').before(60);
  ...
  it('to have attribute equal and waitFor [FAILED] - attribute not equal', function() {
    ...
    const expect = this.client.api.expect.element('#weblogin').to.have.attribute('class').equal('hp vasq').before(11);
